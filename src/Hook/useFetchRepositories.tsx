...
import { setDataRepositories, setTotalPage } from "../Redux/Reducer/repositoriesSlice";

export default function useFetchRepositories(dispatch: Dispatch<UnknownAction>, 
    name: string, page: number, sort: 
    string, order: string, navigate: NavigateFunction) {
    useEffect(() => {
        async function get() {
